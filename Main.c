...
#include<stdlib.h>
int StudentNum  = 0 ;
char StudentStute[7][50] = {"在校","退学","降级","休学","毕业","转专业"};
//                             0     1      2     3       4
void Exit();
...
void saveToFile(){
	FILE * FI  = fopen("Data.bin","wb");
	fwrite(&Data[0],sizeof(StudentInf),StudentNum,FI);
	fclose(FI);
}
void ReadFileData(){
	FILE * FI  = fopen("Data.bin","rb");
	while(fread(&Data[StudentNum],sizeof(StudentInf),1,FI) == 1){
		StudentNum++;
	}
	fclose(FI);
}
...
void StudentPrintSelect(int StudentPos){ // 打印学生客户端的操作信息
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
        	if(Data[StudentPos].nianji>0&&Data[StudentPos].nianji<5){
        		//在大一大四之间
    ...
    do{
        ...
        switch(Command){
            ...
            case 9:
                ...
                break;
            case 10:
                printf("0.在校 1.退学 2 降级 3.休学 4.毕业 5.转专业\n");
                printf("请输入学生状态(输入数字):");
                scanf("%d",&Stute);
